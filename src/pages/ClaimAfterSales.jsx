            ...
            <div className=''>
                ...
                <div className='lg:flex lg:flex-1  lg:px-20  my-4 lg:space-x-4 px-4'>
                    ...
                    <div className='bg-gradient-to-b from-gray-100 to-gray-50 flex-[0.5] p-4 rounded-xl font-poppins'>
                        <p className='my-4 flex justify-center'>Presale Has Ended</p>
                        <div>
                            <div className='mt-4 mb-1 bg-gray-300 rounded-2xl p-1'>
                                <ProgressBar completed={100} labelClassName='' bgColor='#194FFF' customLabel=' ' />
                        ...
                        <p className='font-semibold text-[12px]'>Your Allocation</p>
                        <p className='text-[12px]'>20,000 BGMSK</p>
                        <button className='flex mx-auto w-1/2 bg-blue-600 lg:w-[100px] p-1 text-[9px] font-semibold rounded-full text-white font-poppins'>Claim 3000(BGMSK)</button>
                        <p className='my-4 flex justify-center'>Your Allocation Claiming Over 5 days</p>
                        <div>
                            <div className='mt-4 mb-1 bg-gray-300 rounded-2xl p-1'>
                                <ProgressBar completed={30} labelClassName='' bgColor='#194FFF' customLabel=' ' />
                        ...
                        <div className='bg-gray-300 rounded-sm py-2 px-2 my-4 w-3/4 flex justify-center mx-auto font-poppins '>
                            <p className='flex justify-center text-[15px]'>You have claimed 3,000 out of 20,000BGMSK</p>
...
export default ClaimAfterSales
