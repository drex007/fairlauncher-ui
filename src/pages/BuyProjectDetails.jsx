                    ...
                    <div className='lg:flex lg:flex-1  lg:px-20  my-4 lg:space-x-4 px-4'>
                        <div className='lg:flex-[0.5] w-full flex space-x-4 lg:min-h-56 h-[150px] bg-gray-100 p-2 rounded-xl shadow-sm sm:px-4 lg:my-0 mb-4'>
                            ...
                            <div>
                                ...
                                <button className=' bg-button-blue w-[135px] text-[11px] mt-10  font-semibold text-primary-yellow p-2 rounded-full font-poppins' onClick={() => setModals({ ...modals, showBuyProjectModal: true })}>Buy BigMusk</button>
