...
import { arrowRightSVg, warning } from '../assets'
import ProgressBar from "@ramonak/react-progress-bar";
import { AppContext } from '../contextProvider'
import ForFeitSaleModal from '../modals/ForFeitSaleModal'

const ViewAndClaimBeforeLaunch = () => {
    ...
    return (
        <>
            {modals.showForfeitSaleModal && (<ForFeitSaleModal />)}
                ...
                <div className=''>
                    ...
                    <div className='lg:flex lg:flex-1  lg:px-20  my-4 lg:space-x-4 px-4'>
                        ...
                        <div className='bg-gradient-to-b from-gray-100 to-gray-50 flex-[0.5] p-4 rounded-xl font-poppins'>
                            ...
                            <p className='font-semibold text-[12px] mt-4 mb-2'>Your Allocation</p>

                            <p className='text-[15px]'>200 SOL // 20,000 BGMSK</p>
                            ...
                            <div>
                                <button className='bg-gray-300 rounded-full text-[15px] text-button-blue px-4 py-3 flex mx-auto my-2' onClick={() => setModals({ ...modals, showForfeitSaleModal: true })}>Forfeit Sale</button>
                                <div className='bg-gray-300 rounded-md text-[15px] text-button-blue px-2 py-3 flex justify-center lg:w-2/3 w-full mx-auto'>
                                    <p>You will be charged 5% for forfeiting sale</p>
                                </div>
...
export default ViewAndClaimBeforeLaunch
