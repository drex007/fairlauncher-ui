...
import { gstring, ios, medium, nextdoor, parma, pointer, reload, rocket } from '../assets'

const LaunchNow = () => {
    return (
        <div className='px-16 pb-3'>
            <div className='flex justify-start'>
                <p className='md:text-[35px]  text-[20px] font-semibold text-primary-black-text font-poppins md:ml-8 ml-16 mb-4'>Launch <span className='text-blue-600'>Now</span> </p>
                <img src={pointer} alt="" className='md:ml-2 md:w-[40px] md:my-6 w-[30px] my-4 ' />
            </div>
