    ...
    return (
        <div className='bg-transparent'>
            <div className='grid'>
                ...
                <div className='overflow-hidden lg:w-2/5 flex justify-center items-center space-x-8 mx-auto max-md:px-1'>
                    ...
                    <img src={arrowRight} alt="" width={20} className='cursor-pointer max-sm:-ml-2'/>
                </div>
