  ...
  return (
    <div className='px-16 my-8 md:h-[140px] h-[150px] py-4 md:w-full'>
      <div className='bg-black  h-full rounded-2xl md:flex md:flex-1 px-8 py-4'>
        ...
        <div className='md:flex-[0.5] text-white font-poppins flex flex-col items-center justify-center  font-semibold md:ml-10  md:items-start md:text-[15px] mb-4 text-[12px]'>
