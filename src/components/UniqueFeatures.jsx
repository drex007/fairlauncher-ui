...
const UniqueFeatures = () => {
  return (
    <div className='lg:flex lg:flex-1 2xl:mt-28  2xl:px-48 lg:px-16 px-8 my-8'>
      ...
      <div className='flex-[0.5] flex justify-end space-x-10 items-center'>
        <div className='2xl:w-1/3 w-2/5'>
          <div className='flex space-x-2 2xl:my-4 my-2'>
            ...
            <div className='font-poppins py-3 px-2 bg-gray-200 rounded-lg 2xl:text-[26px] 2xl:text-primary-black-text 2xl:p-8 lg:text-[13px] text-[10px]'>
