    ...
    <div className='lg:flex lg:flex-1 lg:px-16 px-8 my-8'>
      <div className='flex-[0.5]'>
        <div className='lg:ml-16'>
          <p className='text-blue-700 lg:text-[40px] font-semibold text-[25px] flex lg:justify-start   justify-center'>Unique Features</p>
          <p className='text-primary-black-text font-semibold font-poppins lg:text-[40px] text-[25px] flex  lg:justify-start justify-center'>Of FairLauncher</p>
        </div>
      ...
      <div className='flex-[0.5] flex justify-normal space-x-10 items-center'>
        <div className='w-2/5'>
          <div className='flex space-x-2 my-2'>
            <p className='h-[10px] w-[25px] bg-primary-yellow mt-4'></p>
            <div className='font-poppins py-3 px-2 bg-gray-200 rounded-lg lg:text-[13px] text-[10px]'>
